...
build-1002995119:
	@$(MAKE) --no-print-directory -Onone -f subdir_rules.mk build-1002995119-inproc

build-1002995119-inproc: ../Stepper_test.ino
	@echo 'Building file: "$<"'
