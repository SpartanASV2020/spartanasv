...
build-811800911:
	@$(MAKE) --no-print-directory -Onone -f subdir_rules.mk build-811800911-inproc

build-811800911-inproc: ../stepper.ino
	@echo 'Building file: "$<"'
