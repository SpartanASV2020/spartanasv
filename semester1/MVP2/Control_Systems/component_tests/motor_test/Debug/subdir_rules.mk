...
build-1694326993:
	@$(MAKE) --no-print-directory -Onone -f subdir_rules.mk build-1694326993-inproc

build-1694326993-inproc: ../motor_test.ino
	@echo 'Building file: "$<"'
